    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="grid gap-6">
        <div className="border rounded-xl p-6 bg-card space-y-4">
          <h3 className="font-semibold text-lg">Integração Google Drive</h3>
          ...
          <div className="pt-2">
            <button className="bg-secondary text-secondary-foreground hover:bg-secondary/80 px-4 py-2 rounded-md text-sm font-medium w-full">
              Testar Conexão
            </button>
          </div>
        </div>
